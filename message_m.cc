...
void Message::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->nodeNumber);
    doParsimPacking(b,this->nodeKey);
    doParsimPacking(b,this->originalMessage);
}

void Message::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->nodeNumber);
    doParsimUnpacking(b,this->nodeKey);
    doParsimUnpacking(b,this->originalMessage);
}

int Message::getNodeNumber() const
{
    return this->nodeNumber;
}

void Message::setNodeNumber(int nodeNumber)
{
    this->nodeNumber = nodeNumber;
}

int Message::getNodeKey() const
{
    return this->nodeKey;
}

void Message::setNodeKey(int nodeKey)
{
    this->nodeKey = nodeKey;
}

const char * Message::getOriginalMessage() const
{
    return this->originalMessage.c_str();
}

void Message::setOriginalMessage(const char * originalMessage)
{
...
int MessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "nodeNumber")==0) return base+0;
    if (fieldName[0]=='n' && strcmp(fieldName, "nodeKey")==0) return base+1;
    if (fieldName[0]=='o' && strcmp(fieldName, "originalMessage")==0) return base+2;
...
std::string MessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Message *pp = (Message *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getNodeNumber());
        case 1: return long2string(pp->getNodeKey());
        case 2: return oppstring2string(pp->getOriginalMessage());
        default: return "";
    }
}
...
bool MessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Message *pp = (Message *)object; (void)pp;
    switch (field) {
        case 0: pp->setNodeNumber(string2long(value)); return true;
        case 1: pp->setNodeKey(string2long(value)); return true;
        case 2: pp->setOriginalMessage((value)); return true;
